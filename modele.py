...
def all():
    ...
    model = keras.models.load_model("C:/Users/naouf/Documents/1-Naoufel/1-projet/7-Hachaton/Hackaton-Gr2/modele/model_final_1.h5")
    model.summary()
    ...
    def predict_emotion(audio_file):
        ...
        pkl_file = open("C:/Users/naouf/Documents/1-Naoufel/1-projet/7-Hachaton/Hackaton-Gr2/Departure_encoder.pkl", 'rb')
    ...
    print("test",predicted_emotion, prob[1])

    audio_file_path = "output.wav"
    predicted_emotion , prob = predict_emotion(audio_file_path)
