...
print("Accuracy of the model on test data:", test_accuracy * 100, "%")

# Tracer un graphique montrant la perte (loss) et l'exactitude (accuracy) sur les données de test
plt.figure(figsize=(12, 6))

# Perte (loss) sur les données de test
plt.subplot(1, 2, 1)
...
# Exactitude (accuracy) sur les données de test
plt.subplot(1, 2, 2)
